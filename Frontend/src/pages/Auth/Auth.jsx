      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl font-bold text-red-600 leading-tight">
              CRIE, PERSONALIZE E ORGANIZE SUAS FICHAS DE RPG COM ESTILO
            </h1>
            <p className="text-xl text-white">
              Uma plataforma simples e poderosa para quem vive aventuras épicas.
            </p>
            <button
              type="button"
              onClick={() => {
          ...
          <div className="flex justify-center">
            <form
              ...
              className="w-full max-w-md bg-zinc-900 border-2 border-red-600 p-8 rounded-lg red-border-glow space-y-6"
            >
              {!isLogin && (
                <Input
                  name="nome"
              ...
              <div className="flex gap-4">
                <button
                  type="submit"
                  disabled={loading}
                  className={`flex-1 btn-primary py-3 ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
                >
              ...
              <p className="text-center text-sm text-white cursor-pointer hover:text-red-600 transition">
                Esqueceu a senha?
              </p>
            </form>
          </div>
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-white max-w-3xl">
            A Ordem das Fichas nasceu da paixão por RPG e pela vontade de tornar a criação de fichas mais rápida, moderna e leve. Aqui, jogadores e mestres têm tudo em um só lugar.
          </p>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-lg text-white mb-6">
                O projeto foi desenvolvido para colocar em prática os pilares do desenvolvimento web moderno. Nesse foco foi aplicar o que aprendemos no curso, criando uma aplicação completa — do front-end ao back-end.
              </p>
            </div>
            <div>
